...
width={115} height={38} alt='grinibble'/>

<p className='text-start text-sm font-normal mt-5 max-w-xs'>
Lorem, ipsum dolor sit amet consectetur adipisicing elit. Libero impedit quis provident facere inventore, consequuntur .</p>
...
{/* <div className="flexBetween footer__copyrig"></div>
 */}
